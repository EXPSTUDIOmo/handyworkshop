...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 854.0, 87.0, 22.0 ],
					"text" : "mo.waldPlayer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.0, 780.0, 180.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 669.0, 626.0, 150.0, 129.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 672.0, 626.0, 150.0, 129.0 ],
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "ForestAtmo.wav",
								"filename" : "ForestAtmo.wav",
								"filekind" : "audiofile",
								"id" : "u506008840",
								"selection" : [ 0.451977401129944, 1.0 ],
								"loop" : 1,
								"content_state" : 								{
									"loop" : 1
								}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 669.0, 567.0, 232.0, 31.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 428.0, 780.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 428.0, 626.0, 150.0, 129.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 70.5, 350.0, 150.0, 129.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					...
					"outlettype" : [ "multichannelsignal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 567.0, 232.0, 31.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 864.0, 459.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 864.0, 496.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 63.0, 152.0, 150.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 637.0, 204.0, 244.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 582.0, 142.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 528.666666666666742, 245.0, 50.0, 63.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 467.666666666666686, 245.0, 50.0, 63.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 406.666666666666686, 245.0, 50.0, 63.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 406.666666666666686, 200.0, 141.0, 22.0 ],
									"text" : "unpack f f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 370.666666666666686, 156.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 209.0, 306.0, 55.0, 22.0 ],
									"text" : "pipe 300"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 322.0, 344.0, 35.0, 22.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 904.0, 411.0, 55.0, 22.0 ],
									"text" : "dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 209.0, 344.0, 111.0, 22.0 ],
...
,
									...
									"output_texture" : 0,
									"parameter_enable" : 0,
									"patching_rect" : [ 209.0, 394.0, 448.0, 37.0 ],
									"saved_attribute_attributes" : 									{
										"candicane2" : 										{
											"expression" : ""
										}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 209.0, 456.0, 342.0, 180.0 ],
									"sync" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 99.0, 552.0, 55.0, 22.0 ],
									"text" : "dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 99.0, 397.0, 48.0, 136.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 101.0, 352.0, 60.0, 22.0 ],
									"text" : "play~ test"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "start" ],
									"patching_rect" : [ 101.0, 276.0, 39.0, 22.0 ],
									"text" : "t start"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 200.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 50.0, 100.0, 660.333333333333371, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 241.0, 69.0, 22.0 ],
									"text" : "buffer~ test"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 87.0, 65.0, 22.0 ],
					"text" : "script stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 87.0, 66.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 52.0, 312.0, 111.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 134.5, 126.5, 61.5, 126.5 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-5::obj-33" : [ "live.dial", "live.dial", 0 ],
			"obj-5::obj-34" : [ "live.dial[1]", "live.dial", 0 ],
			"obj-5::obj-35" : [ "live.dial[2]", "live.dial", 0 ],
			"obj-62" : [ "mc.live.gain~", "Atmo", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [ 			{
				"name" : "ForestAtmo.wav",
				"bootpath" : "~/Documents/GitHub/handyworkshop",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
...
, 			{
				"name" : "mo.waldPlayer.maxpat",
				"bootpath" : "~/Documents/GitHub/handyworkshop/maxpatches",
...
, 			{
				"name" : "wald1.mp3",
				"bootpath" : "~/Documents/GitHub/handyworkshop/public/samples",
